...
int main()
{
	...
	Matrix2D translationMatrix = Matrix2D(Vector2Df(12.f, 5.f), 0.f, Vector2Df(1.f, 1.f));
	translationMatrix.Print();

	Matrix2D rotationMatrix = Matrix2D(Vector2Df(0.f, 0.f), 90.f, Vector2Df(1.f, 1.f));
	rotationMatrix.Print();

	(rotationMatrix * translationMatrix).Print();

	Matrix2D someMatrix = Matrix2D(Vector2Df(13.f, 25.f), 90.f, Vector2Df(1.5f, 1.f));
	someMatrix.Print();
